...
class ModelWrapper:
    ...
    def train(self, data, optimizer_name="adam", loss_name="cross_entropy", epochs=100, learning_rate=0.001, num_layers=2, hidden_channels=16):
        ...
        for epoch in range(epochs):
            ...
            # print first 10 values of out_np
            #print(out_np[:10])
            ...
            results = [
                {"layers": num_layers, "hidden_channels": hidden_channels, "epochs": epoch+1,
                    "train_loss": train_loss_cpu, "train_accuracy": train_accuracy, "test_loss": test_loss, "test_accuracy": test_accuracy},
            ]
            save_training_results(self.output_path, results)
            
        mad_value = mean_average_distance(out, edge_index=data.edge_index)
    ...
    def test(self, data, loss_name="cross_entropy"):
        ...
        return test_loss.item(), test_accuracy  # Return the test loss and accuracy
...
def save_training_results(filename, results):
    ...
    with open(filename, 'a', newline='') as csvfile:
        fieldnames = ['layers', "hidden_channels", "epochs", 'train_loss', 'train_accuracy', 'test_loss', 'test_accuracy']
