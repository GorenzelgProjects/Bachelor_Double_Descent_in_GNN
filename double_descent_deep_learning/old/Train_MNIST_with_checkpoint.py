...
def main():
    ...
    for i in range(start_i, 32):
        ...
        for j in range(start_j if i == start_i else 1, 4):
            ...
            # Train the model
            train_model(model, trainloader, testloader, criterion, optimizer, num_epochs=300, checkpoint_path=checkpoint_path, csv_file=csv_file, k=k, dataset_fraction=dataset_fraction)
