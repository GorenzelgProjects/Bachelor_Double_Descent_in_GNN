...
class gen_hyper_graph:
    ...
    def __init__(self):
        ...
        self.data_path=r'./dataset'
        self.label_path=r'dataset'
        self.output_path=r'dataset'
        self.datasets=['MUTAG']
        self.node_label_count={'MUTAG':7}
...
if __name__ == '__main__':
    ...
    MUTAG_dataset = TUDataset(root="../dataset/loaded/", 
                               name="MUTAG")
    
    MUTAG_labels = MUTAG_dataset.data.y.tolist()
    
    ghg.data = MUTAG_dataset
    ghg.labels = MUTAG_labels
    ghg.run()
    print('done')